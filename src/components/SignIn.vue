<template>
    ...
    <div class="uk-flex uk-flex-center uk-flex-wrap container">
        <div class="uk-card uk-card-default uk-padding-remove uk-card-large uk-card-body uk-width-1-3@s" style="padding: 40px 20px !important; min-width: 400px">
            ...
            <div class="uk-margin">
                <input class="uk-input uk-form-width-medium" v-model="signInLogin.email" type="email" style="width: 100%" placeholder="Email">
            </div>
            <div class="uk-margin">
                <input class="uk-input uk-form-width-medium" v-model="signInLogin.password" type="password" style="width: 100%" placeholder="Contraseña">
            </div>
...
methods:{
    changeRoute(){
        this.$router.push({ name: 'sign-up' }).catch(() => {})
    }
}
}
</script>
